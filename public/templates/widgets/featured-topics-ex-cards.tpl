<div data-widget="featuredTopicsExCards" class="featuredTopicsExCards">
  <div class="row" itemscope itemtype="http://www.schema.org/ItemList">
  <!-- BEGIN topics -->
    <li class="<!-- IF topics.category.class -->{topics.category.class}<!-- ELSE -->col-md-3 col-sm-6 col-xs-12<!-- ENDIF topics.category.class --> category-item" data-cid="{topics.category.cid}" data-numRecentReplies="{topics.category.numRecentReplies}" style="text-shadow:{textShadow};">
      ...
      <a style="color: {topics.category.color};" href="{config.relative_path}/topic/{topics.slug}" itemprop="url">
        <div class="recent-card">
          <div class="bg" style="opacity:{backgroundOpacity};<!-- IF topics.category.image -->background-image: url({topics.category.image});<!-- ELSE --><!-- IF topics.category.bgColor -->background-color: {topics.category.bgColor};<!-- ENDIF topics.category.bgColor --><!-- ENDIF topics.category.image -->"></div>
