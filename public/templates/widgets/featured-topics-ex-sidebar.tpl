<div data-widget="featuredTopicsExSidebar">
	<ul>
      ...
      <!-- ENDIF topics.thumb -->
			...
			<br>
      <span>by <a href="<!-- IF topics.user.userslug -->{relative_path}/user/{topics.user.userslug}<!-- ELSE -->#<!-- ENDIF topics.user.userslug -->">{topics.user.username}</a></span>
      <br>
			<span class="pull-right">posted <a href="{relative_path}/topic/{topics.slug}"><span class="timeago" title="{topics.timestampISO}"></span></a></span>
		</li>
		<!-- END topics -->
	</ul>
</div>
