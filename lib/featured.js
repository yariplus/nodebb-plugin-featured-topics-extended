...
exports.getFeaturedTopicsLists = async (uid, theirid) => {
  ...
  await createDefaultFeaturedList(theirid)
...
exports.featureTopic = async (theirid, tid, slug) => {
  ...
  if (!exists) {
    winston.error(`List ${list} does not exist.`)
    return // throw new Error(`List ${list} does not exist.`)
  }
