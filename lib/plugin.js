...
exports.init = ({app: _app, router, middleware}, next) => {
  app = _app
  settings = new Settings('featured-topics-extended', '1.0.0', defaultSettings)

  routeHelpers.setupPageRoute(router, '/news', middleware, [], renderNewsPage)
  routeHelpers.setupPageRoute(router, '/news/:page', middleware, [], renderNewsPage)
  routeHelpers.setupPageRoute(router, '/featured', middleware, [], renderEditor)
  ...
  routeHelpers.setupPageRoute(router, '/user/:userslug/blog', middleware, [], renderBlogPage)
  routeHelpers.setupPageRoute(router, '/user/:userslug/blog/:page', middleware, [], renderBlogPage)
  routeHelpers.setupPageRoute(router, '/user/:userslug/featured/:listslug', middleware, [], renderBlogPage)
  routeHelpers.setupPageRoute(router, '/user/:userslug/featured/:listslug/:page', middleware, [], renderBlogPage)

  routeHelpers.setupPageRoute(router, '/user/:userslug/featured', middleware, [], renderUserFeatured)
  ...
  routeHelpers.setupAdminPageRoute(router, '/admin/plugins/featured-topics-extended', middleware, [], renderAdmin)
