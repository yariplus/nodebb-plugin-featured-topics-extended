...
exports.setup = async ({router, middleware}) => {
  routeHelpers.setupPageRoute(router, '/featured', middleware, [], controllers.renderAdminLists)
  routeHelpers.setupPageRoute(router, '/user/:userslug/featured', middleware, [], controllers.renderUserLists)
